...
from models_blurhandnet.modules.unfolder2d import Unfolder
from models_blurhandnet.modules.resnetbackbone import ResNetBackbone
from models_blurhandnet.modules.transformer import Transformer
from models_blurhandnet.modules.regressor_sim import Regressor
from models_blurhandnet.modules.layer_utils import init_weights
...
class BaseModel(nn.Module):
    ...
    def forward(self, inputs, targets, meta_info, mode):
        ...
        feat_joint = self.ktformer(feat_joint)
        
        # regress mano shape, pose and camera parameter
        mano_shape, mano_pose, cam_param = self.regressor(feat_blur, feat_joint, joint_img.detach())
